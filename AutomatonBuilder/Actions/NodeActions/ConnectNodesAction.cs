...
namespace AutomatonBuilder.Actions.NodeActions
{
    public class ConnectNodesAction: IAction
    {
        ...
        private readonly IConnectorData data;
        private readonly MainEditingScreen host;
        private IConnector connector;

        public ConnectNodesAction(AutomatonContext context, ModelNode source, ModelNode destination, IConnectorData text, MainEditingScreen host)
        {
        ...
        {
            this.connector = ConnectorUtils.ConnectNodes(this.context, this.sourse, this.destination, this.data, this.host);
        }
